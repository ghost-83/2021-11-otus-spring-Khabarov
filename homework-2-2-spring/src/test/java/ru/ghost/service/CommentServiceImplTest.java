...
class CommentServiceImplTest {
    ...
    void shouldReturnExpectedCommentsList() {
        given(dao.findAll()).willReturn(List.of(EXPECTED_COMMENT));
    ...
    void shouldReturnExpectedCommentById() {
        given(dao.findById(EXPECTED_COMMENT.getId())).willReturn(EXPECTED_COMMENT);
    ...
    void shouldCreateComment() {
        given(dao.save(any(Comment.class))).willReturn(EXPECTED_COMMENT);
    ...
    void shouldCorrectlyDeleteComment() {
        ...
        int actualDeletedCount = commentService.delete(id);
