...
import ru.ghost.blog.service.GenreService;
...
public class GenreControllerTest {
    ...
    public void findAllTest() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/genre").cookie(cookie)).andExpect(status().isOk());
    }

    @Test
    @DisplayName("fail a list of genres")
    public void findAllFailTest() throws Exception {
        mockMvc.perform(get("/api/v1/genre")).andExpect(status().isForbidden());
    }
}
