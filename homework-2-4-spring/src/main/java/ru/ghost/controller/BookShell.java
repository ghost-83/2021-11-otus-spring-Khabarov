...
public class BookShell {
    ...
    public Book findById(@ShellOption String id) {
        return service.findById(id);
    }

    @ShellMethod(value = "Insert Book", key = {"bins", "book-insert"})
    public String create(@ShellOption String name, @ShellOption String authorId, @ShellOption String genreId) {
    ...
    public String update(@ShellOption String id, @ShellOption String name,
